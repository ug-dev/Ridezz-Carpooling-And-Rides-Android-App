...
public class search_ride_map extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_ride_map);
        ...
        findViewById(R.id.selectPickUpLocation).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (SelectedLocation.latitude == 0 && SelectedLocation.longitude == 0){
                    Toast.makeText(search_ride_map.this, "Location is not selected, Please Move the marker and select again", Toast.LENGTH_SHORT).show();
                }else {
                    db.collection("users").document(user.getUid())
                            .collection("information")
                            .document("search_location_text_field").set(data, SetOptions.merge()).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Intent i = new Intent(search_ride_map.this, dashboard.class);
                            i.putExtra("Selected", "search");
                            startActivity(i);
                        }
...
//    }
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(search_ride_map.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(search_ride_map.this);
    }
